...
dep 'configured fstab', :for => :linux do
	...
	define_var :bootfs, :message => "/boot file system device node ? (type none for no separate partition)", :default => 'none'
	define_var :swapfs, :message => "swap  file system device node ? (type none for no separate partition)", :default => 'none'
	define_var :tmpfs,  :message => "/tmp  file system device node ? (type none for no separate partition)", :default => 'none'
	define_var :varfs,  :message => "/var  file system device node ? (type none for no separate partition)", :default => 'none'
	define_var :usrfs,  :message => "/usr  file system device node ? (type none for no separate partition)", :default => 'none'
	define_var :homefs, :message => "/home file system device node ? (type none for no separate partition)", :default => 'none'
